...
object GenerateClassfileFlags {
  ...
  fun table(html: String): String {
    ...
    builder.append("""
        |# Do not edit this file by hand.  It is generated by Gradle and GenerateClassfileFlags.
        |
  ...
  fun code(table: String): String {
    ...
    val generatorName = "org.ucombinator.jade.gradle.GenerateClassfileFlags" // TODO: use reflection to get class name
