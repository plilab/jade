...
object DecompileClass {
  ...
  private fun decompileAnnotations(nodes: java.util.List<AnnotationNode>): NodeList<AnnotationExpr> {
    return TODO()
  ...
  private fun decompileParameter(
    method: MethodNode,
    paramCount: Int,
    parameter: Pair<Pair<Pair<Pair<Type, Int>, ParameterNode>, java.util.List<AnnotationNode>>, java.util.List<AnnotationNode>>
  ): Parameter {
    return TODO()
  ...
  fun decompileMethod(classNode: ClassNode, node: MethodNode): BodyDeclaration<BodyDeclaration<*>> {
    return TODO()
    // // attr (ignore?)
    // // instructions
    // // tryCatchBlocks
